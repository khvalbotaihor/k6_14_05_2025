...
export default function () {
    ...
    group('News page', function () {
        ...
        let res3 = http.get('https://run.mocky.io/v3/9dc69b21-7d70-40a6-b5a8-aae946ee8532')
        check(res3, { 'is status 200 for news page': (r) => r.status === 200 });
        console.log('response news page: ' + res3.status);
    });
